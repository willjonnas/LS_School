...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonCloseweather.setOnClickListener{
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val temp = String.format("%.1f°C", main.getDouble("temp"))
                val tempMin = String.format("Min Temp: %.1f°C", main.getDouble("temp_min"))
                val tempMax = String.format("Max Temp: %.1f°C", main.getDouble("temp_max"))
